      ...
      ?>
        <form action="<?php echo base_url('Auth/Admin') ?>" method="post">
          <div class="input-group mb-3">
            <input type="number" name="id_user" id="id_user" class="form-control" placeholder="ID Admin" 
                title="ID Admin wajib Diisi dan harus berupa angka." required 
                oninvalid="this.setCustomValidity('ID Admin Wajib Diisi dan harus berupa angka.')"
